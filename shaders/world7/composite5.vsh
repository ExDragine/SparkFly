...
void main(){
	...
	gl_Position.xy=(gl_Position.xy*.5+.5)*.51*2.-1.;
	...
	fogAmount=BASE_FOG_AMOUNT*(fogAmount0+max(FOG_RAIN_MULTIPLIER*1/10.*rainStrength,FOG_TOD_MULTIPLIER*1/50.*clamp(modWT-13000.,0.,1000.)/1000.*(1.-clamp(modWT-23000.,0.,1000.)/1000.)));
